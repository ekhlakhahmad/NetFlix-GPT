			...
			<div className="min-h-screen">
				...
				<div className="opacity-80 pt-28 flex justify-center items-center">
					<form
						...
						className="form-container w-3/4 max-w-md flex flex-col justify-center p-10 bg-[#000000f5] text-white rounded-md">
						...
						{issignIn && (
							<>
								<input
									onChange={handleName}
									className="mt-4 border p-2 rounded-md bg-[#000000f5]"
									type="text"
						...
						<input
							...
							className="mb-4 mt-8 border p-2 rounded-md bg-[#000000f5]"
							type="text"
						...
						<input
							...
							className="my-4 border p-2 rounded-md bg-[#000000f5]"
							type="password"
						...
						<button
							className="my-4 border p-2 rounded-md bg-red-700 text-white font-bold text-md"
						...
						<div className="flex gap-2 justify-center text-gray-300">
							{issignIn ? "Already have account?" : "New to NetFlix?"}
							<h4
